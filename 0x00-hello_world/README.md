...
+ Task 6: [Size is not grandeur, and territory does not make a nation](): A C program that prints the size of various types on the computer it is compiled and run on.</br>
